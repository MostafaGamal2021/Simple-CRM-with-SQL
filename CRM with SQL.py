...
def show_list():
    ...
    def edit():
        first_name_label2 = Label(show_list_window, text="First Name").grid(row=index+2, column=0, sticky=W, padx=10)
        last_name_label2 = Label(show_list_window, text="Last Name").grid(row=index+3, column=0, sticky=W, padx=10)
        address1_label2 = Label(show_list_window, text="Address 1").grid(row=index+4, column=0, sticky=W, padx=10)
        address2_label2 = Label(show_list_window, text="Address 2").grid(row=index+5, column=0, sticky=W, padx=10)
        city_label2 = Label(show_list_window, text="City").grid(row=index+6, column=0, sticky=W, padx=10)
        state_label2 = Label(show_list_window, text="State").grid(row=index+7, column=0, sticky=W, padx=10)
        zipcode_label2 = Label(show_list_window, text="Zip Code").grid(row=index+8, column=0, sticky=W, padx=10)
        country_label2 = Label(show_list_window, text="Country").grid(row=index+9, column=0, sticky=W, padx=10)
        phone_label2 = Label(show_list_window, text="Phone").grid(row=index+10, column=0, sticky=W, padx=10)
        email_label2 = Label(show_list_window, text="Email").grid(row=index+11, column=0, sticky=W, padx=10)
        user_id_label2 = Label(show_list_window, text = "User ID").grid(row = index+12, column = 0, sticky = W, padx = 10)
        payment_method_label2 = Label(show_list_window, text="Payment Method").grid(row=index+13, column=0, sticky=W, padx=10)
        discount_code_label2 = Label(show_list_window, text="Discount Code").grid(row=index+14, column=0, sticky=W, padx=10)
        price_paid_label2 = Label(show_list_window, text="Price Paid").grid(row=index+15, column=0, sticky=W, padx=10)

        first_name_box2 = Entry(show_list_window)
        first_name_box2.grid(row=index+2, column=1, pady=5)
        last_name_box2 = Entry(show_list_window)
        last_name_box2.grid(row=index+3, column=1, pady=5)
        address1_box2 = Entry(show_list_window)
        address1_box2.grid(row=index+4, column=1, pady=5)
        address2_box2 = Entry(show_list_window)
        address2_box2.grid(row=index+5, column=1, pady=5)
        city_box2 = Entry(show_list_window)
        city_box2.grid(row=index+6, column=1, pady=5)
        state_box2 = Entry(show_list_window)
        state_box2.grid(row=index+7, column=1, pady=5)
        zipcode_box2 = Entry(show_list_window)
        zipcode_box2.grid(row=index+8, column=1, pady=5)
        country_box2 = Entry(show_list_window)
        country_box2.grid(row=index+9, column=1, pady=5)
        phone_box2 = Entry(show_list_window)
        phone_box2.grid(row=index+10, column=1, pady=5)
        email_box2 = Entry(show_list_window)
        email_box2.grid(row=index+11, column=1, pady=5)
        user_id_box2 = Entry(show_list_window)
        user_id_box2.grid(row = index+12, column = 1, pady = 5)
        payment_method_box2 = Entry(show_list_window)
        payment_method_box2.grid(row=index+13, column=1, pady=5)
        discount_code_box2 = Entry(show_list_window)
        discount_code_box2.grid(row=index+14, column=1, pady=5)
        price_paid_box2 = Entry(show_list_window)
    ...
    update_butn = Button(show_list_window, text="Update Record", command=update)
    update_butn.grid(row=index + 1, column=2, padx=20)
